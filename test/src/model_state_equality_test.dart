  ...
  return VehiclePosition(
    ...
    stopTimes: [
      VehicleRouteStop(
        ...
        zoneId: 'P',
        shapeDistTraveled: 1200.5,
        arrivalTime: DateTime.utc(2026, 6, 25, 10),
        departureTime: DateTime.utc(2026, 6, 25, 10, 1),
        realtimeArrivalTime: DateTime.utc(2026, 6, 25, 10, 0, 30),
        realtimeDepartureTime: DateTime.utc(2026, 6, 25, 10, 1, 30),
        isWheelchairAccessible: true,
      ),
    ],
